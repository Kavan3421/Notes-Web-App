      ...
      {notes.length === 0 ? (
        ...
        <div className="grid gap-4 grid-cols-1 md:grid-cols-2">
          {notes.map((note) => {
            ...
            const totalViews = note.shares.reduce((acc, s) => acc + s.viewCount, 0);
                    ...
                    <div className="flex gap-1.5 flex-wrap shrink-0">
                      {activeSharesCount > 0 ? (
                        <Badge variant="success" className="text-[10px] font-bold">
                          {activeSharesCount} ACTIVE LINK{activeSharesCount > 1 ? "S" : ""}
                        </Badge>
